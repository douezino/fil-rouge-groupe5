...
INSTALLED_APPS = [
    ...
    # django-allauth added  apps:https://django-allauth.readthedocs.io/en/latest/installation.html
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request', # by default here but allauth needs it as well
...
DATABASES = {
    ...
    'openshiftpostgresql': {  # use command: ./manage.py migrate --database=openshiftpostgresql
        ...
        'USER': os.getenv('POSTGRESQL_USER'),
        'PASSWORD': os.getenv('POSTGRESQL_PASSWORD'),
        'HOST': '10.130.5.225', # openshift deployed postgresql pod ip
        'PORT': '5432',
    }
}
